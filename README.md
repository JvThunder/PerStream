...
See [CHANGELOG.md](CHANGELOG.md) for a detailed list of changes made to the codebase.

## License

This project is for research purposes. Please refer to the license terms of the underlying models (Qwen2.5-Omni) and datasets (DrivenAct, Ego4D) for usage restrictions.